...
var _lynn$wordpet$File$prefetch = _elm_lang$core$Native_Platform.outgoingPort(
	'prefetch',
	function (v) {
		return v;
	});
...
var _lynn$wordpet$Main$prefetchCritterParts = function (model) {
	var parts = A2(
		_elm_lang$core$Basics_ops['++'],
		model.critter.parts,
		{
	...
	var paths = A2(
		...
		function (p) {
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					model.critter.palette,
					A2(
						_elm_lang$core$Basics_ops['++'],
						'/',
						A2(_elm_lang$core$Basics_ops['++'], p, '.png'))));
		},
		parts);
	return _elm_lang$core$Platform_Cmd$batch(
		A2(_elm_lang$core$List$map, _lynn$wordpet$File$prefetch, paths));
};
			...
			default:
				...
				if (_p1.ctor === 'Ok') {
					...
					return A2(
						...
						{
							ctor: '::',
							_0: _lynn$wordpet$Main$prefetchCritterParts(_p2),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								voice: A2(_elm_lang$core$Basics_ops['++'], 'Import error: ', _p1._0)
							}),
						{ctor: '[]'});
				}
		}
